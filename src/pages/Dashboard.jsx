...
<div className="flex gap-4 ml-150 mt-4">
  <button
    onClick={() => navigate("/create-plan")}
    className="bg-white text-orange-600 px-8 py-3 text-xs rounded-full font-semibold shadow hover:bg-orange-100"
  >
    ➕ Create meal plan
  </button>
  ...
  <button
    ...
    className="bg-orange-700 text-white px-8 py-3 text-xs rounded-full font-semibold shadow hover:bg-orange-800"
  >
    📅 My meal Plan
  </button>
</div>
      ...
      style={{
        backgroundImage:
          "url('https://t4.ftcdn.net/jpg/02/32/48/35/360_F_232483527_B9KZazS7LsGexMg0icM1gUNghIcqJDvL.jpg')"
      }}
    >
      <div className="p-6">
